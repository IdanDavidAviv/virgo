...
## 1. Core Stability: Transition to AST Parsing
...
## 3. Observability: Proactive Telemetry
...
- [ ] **Phase 1**: Robust Parsing (Migrate to `markdown-it`).
- [ ] **Phase 2**: Global Reach (Mac/Linux fallback).
- [ ] **Phase 3**: Diagnostics (Telemetry integration).
